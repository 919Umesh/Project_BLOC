...
//   CreateProductBloc({required CreateProductRepository createProductRepository}) :_createProductRepository=createProductRepository, super(CreateProductInitial()) {
...
//
//       final response = await _createProductRepository.createProduct(form: formData);
